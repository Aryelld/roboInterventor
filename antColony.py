...
# baseado no material em https://github.com/pjmattingly/ant-colony-optimization
# por hora este código não foi modificado, mas servirá como base para implementação
# do algoritmo de ACO utilizado
